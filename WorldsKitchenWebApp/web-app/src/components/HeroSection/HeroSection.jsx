    ...
    return (
        <div id={'HeroSection'}>
            <div className={'hero-container'}>
                <h1 className={'hero'}>Explore Authentic <span className="green-text">Flavors</span> from Around
                    the <span className="green-text">World</span></h1>
                <h2 className={'hero-description'}>Embark on a culinary journey through different regions and cultures,
                    and uncover the rich tapestry of flavors, spices, and cooking techniques that define traditional
                    cuisines. Immerse yourself in the vibrant culinary heritage of each region, from the exotic spices
                    of Southeast Asia to the comforting warmth of European classics, and experience the diversity of
                    global gastronomy at your fingertips. Whether you're an aspiring home cook or a seasoned chef, our
                    curated collection of recipes offers something for everyone, allowing you to recreate authentic
                    dishes from around the world in your own kitchen.</h2>
            </div>
